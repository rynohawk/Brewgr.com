...
{
	public class SendToShopReadyMessage : AbstractEmailMessage
	{
		...
		/// ctor the Mighty
		/// </summary>
		public SendToShopReadyMessage(SendToShopOrder sendToShopOrder, Partner partner, PartnerSendToShopSettings partnerSendToShopSettings,
			IWebSettings webSettings)
		{
			...
			this.Subject = "READY FOR PICK-UP: Send-To-Shop Order #: " + sendToShopOrder.SendToShopOrderId;
		...
		public override string BuildMessageBody()
		{
			...
			message.AppendLine("This message is to inform you that your Send-To-Shop order #: " + this.SendToShopOrder.SendToShopOrderId + " is now ready for pickup.");
			message.AppendLine();
